defmodule Kerosene do
  ...
  def paginate(repo, query, opts) do
    ...
    total_count = get_total_count(opts[:total_count], repo, query, repo_opts)
    ...
    {get_items(repo, query, per_page, offset, repo_opts), kerosene}
  end
  ...
  defp get_total_count(count, _repo, _query, opts) when is_integer(count) and count >= 0,
    do: count
